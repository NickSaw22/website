...
<form action="machineinfo.php" method="POST" enctype="multipart/form-data">
<label for="file">Image:</label>
<input type="file" name="mimage" autocomplete="off" class="form-control"><br><br>
<label>Description:</label>
<textarea name="mdes" cols="50" rows="4" placeholder="enter the description" autocomplete="off" class="form-control"></textarea><br>
<div>
